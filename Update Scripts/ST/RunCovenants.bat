...
for /R "%specDirectory%" %%Y IN (*.*) do (
    set soulbind=%%~nY
    CALL "..\simc.exe" "GenericOptions.simc" "!baseFile!" "%%Y"
    MOVE /Y "output.txt" "D:\SimC Scripts\Dump\Output\Cov\ST\R7\!spec!_!soulbind!.txt"
    MOVE /Y "output.json" "D:\SimC Scripts\Dump\Output\Cov\ST\R7\!spec!_!soulbind!.json"
)
exit /B 0
